    ...
    <div data-testid="recht-page">
      ...
      <section className="pb-20 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-5 lg:px-10 grid lg:grid-cols-3 gap-4 lg:gap-6 w-full min-w-0">
          ...
          {/* Side card – Verband */}
          <aside className="min-w-0 bg-[#1E2E24] text-white rounded-3xl p-5 sm:p-8 relative overflow-hidden">
          ...
          {/* GuBO */}
          <article className="lg:col-span-3 min-w-0 bg-white border border-[#E8E3D3] rounded-3xl p-5 sm:p-8 lg:p-10">
          ...
          {/* Schottergärten */}
          <article className="min-w-0 bg-white border border-[#E8E3D3] rounded-3xl p-5 sm:p-8">
          ...
          {/* Disclaimer */}
          <div className="lg:col-span-3 min-w-0 bg-[#1E2E24]/5 border border-[#E8E3D3] rounded-3xl p-4 sm:p-6 text-sm text-[#4B5E53] leading-relaxed">
